...
import com.example.sachin.dharm_fab.ImageUpload;
import com.example.sachin.dharm_fab.R;
...
public class UploadItem extends AppCompatActivity {
    ...
    private EditText quality,rate,length,width,minorder;
    private Spinner spinner1;
    Bitmap bm;
    public static final String FB_STORAGE_PATH = "image/";
    public static final String FB_DATABASE_PATH = "newitem";
    public static final int REQUEST_CODE = 1234;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.uploadnewitem);
        ...
        minorder = (EditText) findViewById(R.id.ordermin);
        ...
        if (imgUri != null) {
            ...
            ref.putBytes(fileInBytes).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                //Dimiss dialog when success
                    ...
                    ImageUpload imageUpload = new ImageUpload(taskSnapshot.getDownloadUrl().toString(),quality.getText().toString(),rate.getText().toString(),length.getText().toString(),i,width.getText().toString(),minorder.getText().toString());
